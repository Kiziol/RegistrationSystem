...
<head>
	...
	<body>
		...
		<h1 style="margin-top: 100px;margin-left: 600px;color: #FF5511 ;">修改队员资料</h1>
		<h2 style="margin-top: 30px;margin-left: 600px;color: #FF0000 ;">所有资料均需填写！</h2>
		<form action="${pageContext.request.contextPath }/StudentServlet?modifysid=${student.sid}" method="post" >
			<table style="margin-left: 100px">
				
			<tr >
				<th style="padding: 15px;">姓名</th>
				<td style="color: #EE7700 ;">
					<input type="text" name="sname" class="_input" value="${student.sname }"/>
				</td>
			</tr>
			...
			<tr>
				...
				<td style="color: #EE7700 ;">
					<input type="text" name="snumber" class="_input" value="${student.snumber }"/>
				</td>
			</tr>
			...
			<tr>
				...
				<td style="color: #EE7700 ;">
					<input type="text" name="telephone" class="_input" value="${student.telephone }"/>
				</td>
			</tr>
			...
			<tr>
				...
				<td style="color: #EE7700 ;">
					<select class="_input" name="colname" id="select">
			...
			<tr>
				...
				<td style="color: #EE7700 ;">
					<input type="text" name="email" class="_input" value="${student.email }"/>
				</td>
			</tr>
			<tr>
