...
<head>
	...
	<body>
		...
		<h1 style="margin-top: 100px;margin-left: 600px;color: #FF5511 ;">修改指导老师资料</h1>
		<h2 style="margin-top: 30px;margin-left: 600px;color: #FF0000 ;">所有资料均需填写！</h2>
		<form action="${pageContext.request.contextPath }/TeacherServlet?modifytcid=${teacher.tcid}" method="post" >
			<table style="margin-left: 100px">
				
			<tr >
				<th style="padding: 15px;">姓名</th>
				<td style="color: #EE7700 ;">
					<input type="text" name="tname" class="_input" value="${teacher.tname}"/>
				</td>
			</tr>
			...
			<tr>
				...
				<td style="color: #EE7700 ;">
					<input type="text" name="telephone" class="_input" value="${teacher.telephone}"/>
				</td>
			</tr>
			...
			<tr>
				...
				<td style="color: #EE7700 ;">
					<input type="text" name="email" class="_input" value="${teacher.email}"/>
				</td>
			</tr>
			<tr>
