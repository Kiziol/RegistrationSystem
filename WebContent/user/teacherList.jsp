...
<body>
	...
	<h1 style="margin-top: 100px;margin-left: 400px;color: #FF5511 ;">指导老师列表</h1>
	<table style="margin-top: 150px;margin-left: 400px;" cellpadding="0" cellspacing="0">
		...
		<c:forEach items="${teacherlist}" var="list">
			...
			<c:if test="${list.state == 2}">
				...
				<td> 
					<a href="${pageContext.request.contextPath }/TeacherServlet?modify=${list.tcid }" class="operation" style="color:#00BBFF; text-decoration:none;">修改</a>
				</td>
			</tr>
		</c:forEach>
